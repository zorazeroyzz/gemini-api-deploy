...
| 配置项 | 推荐值 | 说明 |
|---|---|---|
| `browser_headless` | `false` | headless 模式会被 Google 检测拦截 |
...
[01:46:16] ✓ 登录成功
[01:46:16] ✓ 当前已有 4 个账号
[01:46:16] → 启动注册任务: 5 个账号 (邮箱=duckmail, 域名=duckmail.sbs)
...
- 每个账号注册耗时约 60-70 秒
- 注册的账号 session 有效期约 12 小时，需配合服务端定时刷新功能
- DuckMail 公共 API 无速率限制，但大量注册建议间隔使用
